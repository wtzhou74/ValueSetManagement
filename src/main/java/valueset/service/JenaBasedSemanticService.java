...
public class JenaBasedSemanticService {
	...
	/**
	 * Get all information of directly connected nodes of given concept
	 * 
	 * @param terminology
	 * @param relation
	 * @param conceptCode
	 * @return
	 */
	/*public SemanticRelationModelView queryBySpecificRelationAndConceptCode(String terminology,
			String conceptCode) {
